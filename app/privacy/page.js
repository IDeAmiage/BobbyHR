export default function Privacy() {
  return (
    <>
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of IDeA.</p>
      ...
      <p>Note that IDeA has no access to or control over these cookies that are used by third-party advertisers.</p>
      ...
      <p>IDeA does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
