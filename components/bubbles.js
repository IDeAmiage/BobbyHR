...
function Swarm({ count, ...props }) {
  ...
  return (
    <instancedMesh ref={mesh} args={[null, null, count]} castShadow="true" receiveShadow="true" {...props}>
...
export default function Bubbles() {
  return (
    <Canvas style={{height: '50%', width:'50%'}} shadows gl={{ alpha: false, antialias: false }} camera={{ fov: 75, position: [0, 0, 60], near: 10, far: 150 }}>
